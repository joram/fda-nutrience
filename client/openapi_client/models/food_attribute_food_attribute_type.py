...
class FoodAttributeFoodAttributeType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FoodAttributeFoodAttributeType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FoodAttributeFoodAttributeType:
        """Create an instance of FoodAttributeFoodAttributeType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FoodAttributeFoodAttributeType.parse_obj(obj)

        _obj = FoodAttributeFoodAttributeType.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
