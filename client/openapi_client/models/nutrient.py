...
class Nutrient(BaseModel):
    ...
    __properties = ["id", "number", "name", "rank", "unitName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Nutrient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Nutrient:
        """Create an instance of Nutrient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Nutrient.parse_obj(obj)

        _obj = Nutrient.parse_obj({
            "id": obj.get("id"),
