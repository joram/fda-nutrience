...
class FoodComponent(BaseModel):
    ...
    is_refuse: Optional[StrictBool] = Field(default=None, alias="isRefuse")
    min_year_acquired: Optional[StrictInt] = Field(default=None, alias="minYearAcquired")
    percent_weight: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="percentWeight")
    __properties: ClassVar[List[str]] = ["id", "name", "dataPoints", "gramWeight", "isRefuse", "minYearAcquired", "percentWeight"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "isRefuse": obj.get("isRefuse"),
            "minYearAcquired": obj.get("minYearAcquired"),
            "percentWeight": obj.get("percentWeight")
        })
        return _obj
