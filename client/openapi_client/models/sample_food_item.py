...
class SampleFoodItem(BaseModel):
    ...
    food_attributes: Optional[List[FoodCategory]] = Field(default=None, alias="foodAttributes")
    __properties: ClassVar[List[str]] = ["fdcId", "datatype", "description", "foodClass", "publicationDate", "foodAttributes"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "foodAttributes": [FoodCategory.from_dict(_item) for _item in obj.get("foodAttributes")] if obj.get("foodAttributes") is not None else None
        })
        return _obj
